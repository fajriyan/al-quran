...
useEffect(()=>{
 ...
 const handleTheme = () => {
  ...
  return (
    <div className="backdrop-blur-sm bg-white/90 dark:bg-gray-800/90 border-b dark:border-slate-400 sticky top-0 z-[100]">
      <div className="navbar container mx-auto  ">
        <div className="flex-1">
          <LinkProgresBars
            to="/"
            className="btn gap-2 btn-md border-none bg-[conic-gradient(at_left,_var(--tw-gradient-stops))] from-sky-400 to-blue-800 hover:bg-[conic-gradient(at_right,_var(--tw-gradient-stops))] hover:from-sky-300 hover:to-blue-700 focus:ring-2 ring-offset-2 ring-blue-700 text-white dark:text-slate-200"
          >
            <svg
          ...
          <ul className="menu menu-horizontal ">
            ...
            {theme == "dark"?(
                  <button onClick={handleTheme}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-moon-stars-fill" viewBox="0 0 16 16">
