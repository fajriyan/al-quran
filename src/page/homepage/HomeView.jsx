         ...
         <>
            <div className="min-h-screen dark:bg-slate-950 sm:px-5 2xl:px-0">
               ...
               <div className="container mx-auto sm:py-5">
                  <div
                     className="hero min-h-[200px] rounded-none sm:rounded-xl flex flex-wrap relative bg-cover overflow-hidden mb-5"
                     style={{
                        ...
                        {lanjutBaca[0].ayat ? (
                           <div className="container mx-auto h-full">
                              <div
                                 ...
                                 className="flex flex-row w-full bg-white dark:bg-slate-900 h-full rounded-xl border-dashed shadow-xs hover:border-slate-600 border border-slate-300 overflow-hidden"
                              >
                                 <Link to={`/surah/${lanjutBaca[0].url}`} className="flex justify-between w-full gap-0 p-4!">
                                    <div className="flex items-center">
                                       <div className="text-left">
                                          <div className="card-title font-serif mt-1">{lanjutBaca[0].surat}</div>
                                          <div>
                                 ...
                                 <div className="flex">
                                    <button type="button" onClick={() => removeBookmark()} className="px-5 border bg-slate-200 group">
                                       <svg
                                          xmlns="http://www.w3.org/2000/svg"
                                          width="20"
                                          height="20"
                     ...
                     {Loading ? (
                        filteredData.length === 0 ? (
                           <div className="p-4 col-span-3 border border-dashed border-slate-400 dark:border-slate-500 w-full text-md md:flex gap-1 items-center rounded-md h-min">
                              Maaf, Surah <span className="font-semibold underline">{querySearch}</span> tidak ditemukan, silahkan periksa kembali pencarian anda.{" "}
                              <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" className="bi bi-info-circle-fill" viewBox="0 0 16 16">
                              ...
                              >
                                 ...
                                 <div className="p-4 relative overflow-hidden">
                                    <img
                                       ...
                                       loading="lazy"
                                    />
                                    <h2 className={`font-semibold mb-0 font-serif relative z-2 ${isFriday ? "text-yellow-900 dark:text-yellow-50" : ""}`} key={s.nama_latin}>
                                    ...
                                    <div className="flex gap-3 items-center justify-between border-t border-r-slate-300 dark:border-gray-700 mt-4 pt-2">
                                       ...
                                       <div key={index} className="flex gap-2 items-center border border-slate-500 sm:pl-2 rounded-lg overflow-hidden z-2">
                                          ...
                                          <button
                                             ...
                                             className={`px-2 py-2 rounded-l-md  border-none hover:shadow-lg focus:ring-2 ring-offset-2 ring-slate-800 ${isFriday ? "bg-linear-to-r from-indigo-200 via-red-200 to-yellow-200 dark:from-indigo-200 dark:via-red-100 dark:to-yellow-100 text-gray-900" : "bg-linear-to-r hover:bg-linear-to-t from-slate-800 to-slate-700 text-white fill-white"}`}
                                          >
                                             {loadingIndex === index ? (
