         ...
         <div className="container mx-auto text-slate-800 dark:text-slate-200 px-5 lg:px-0">
            <div className="pt-[80px] text-center flex items-center flex-col">
               ...
               <p className="text-xs w-[85%] md:w-[40%] mt-1">
                  Melansir buku karya Hasan al-Banna yang berjudul Al-Ma'tsurat bahwasanya baca dari Al Matsurat yang shahih dan berasal dari Nabi SAW ini sangat bagus jika
            ...
            <div className="mt-5 px-5 flex flex-wrap justify-end md:h-full md:items-center rounded-lg border border-slate-300 dark:border-slate-400/80 pt-14 pb-5 md:py-9 relative">
               <div className="text-xl md:ml-5 flex justify-between md:block gap-1 px-3 top-2 w-full mb-3 md:w-fit md:mb-0 md:px-0 absolute left-0 border-b border-dashed border-slate-200 pb-2 md:border-0">
                  <div className="flex md:block w-full gap-2">
                     <div className="w-auto border md:border-slate-200 rounded-md text-sm px-1 lg:mt-3 nunito font-semibold">Taawudz</div>
                  </div>
               </div>

               <div className="arab w-full" style={{ fontSize: option.ar + "px" }}>
                  أَعُوذُ بِاللَّهِ مِنَ الشَّيْطَانِ الرَّجِيمِ <span className="relative"> ۝</span>
               </div>
               <p className="w-full text-left mt-2 text-[15px] lg:mt-7 nunito" style={{ fontSize: option.id + "px" }}>
               ...
               <div className="flex border-b border-gray-300 dark:border-slate-500">
                  <button
                     ...
                     className={`py-2 px-4 border-b-2 focus:outline-hidden ${
                        activeTab === 0 ? "border-gray-700 text-gray-700 dark:border-gray-200 dark:text-gray-200" : "border-transparent text-gray-500"
                     }`}
                  >
                     Pagi Hari
                  </button>
                  <button
                     ...
                     className={`py-2 px-4 border-b-2 focus:outline-hidden ${
                        activeTab === 1 ? "border-gray-700 text-gray-700 dark:border-gray-200 dark:text-gray-200" : "border-transparent text-gray-500"
                     }`}
                  >
                     Sore Hari
                  </button>
                     ...
                     <div className="pagi hari">
                        <section>
                           <div className="flex flex-col items-center mt-10 mb-2 font-semibold">
                              <span className="border border-slate-400 px-3 py-1 rounded-md">Surat Al Fatihah - 1X</span>
                           </div>
                           ...
                           <div className="border border-slate-300 rounded-lg overflow-hidden">
                              {data.alfatihah.map((surat) => (
                                 ...
                                 >
                                    <div className="text-xl md:ml-5 flex justify-between md:block gap-1 px-3 top-2 w-full mb-3 md:w-fit md:mb-0 md:px-0 absolute left-0 border-b border-dashed border-slate-200 pb-2 md:border-0">
                                       <div className="flex md:block w-full gap-2">
                                          <div className="w-auto border md:border-slate-200 rounded-md text-sm px-1 lg:mt-3 nunito font-semibold">Al Fatihah : {surat.nomor}</div>
                                       </div>
                                    </div>

                                    <div className="arab w-full lg:mt-5" style={{ fontSize: option.ar + "px" }}>
                                       {surat.ar}
                        ...
                        <section>
                           <div className="flex flex-col items-center mt-10 mb-2 font-semibold">
                              <span className="border border-slate-400 px-3 py-1 rounded-md">Surat Al Baqarah (1-5) - 1X</span>
                           ...
                           <div className="border border-slate-300 rounded-lg overflow-hidden">
                              {data.albaqarah15.map((surat) => (
                                 ...
                                 >
                                    <div className="text-xl md:ml-5 flex justify-between md:block gap-1 px-3 top-2 w-full mb-3 md:w-fit md:mb-0 md:px-0 absolute left-0 border-b border-dashed border-slate-200 pb-2 md:border-0">
                                       <div className="flex md:block w-full gap-2">
                                          <div className="w-auto border md:border-slate-200 rounded-md text-sm px-1 lg:mt-3 nunito font-semibold">Al Baqarah : {surat.nomor}</div>
                                       </div>
                                    </div>
                        ...
                        <section>
                           <div className="flex flex-col items-center mt-10 mb-2 font-semibold">
                              <span className="border border-slate-400 px-3 py-1 rounded-md">Surat Al Baqarah (255-257) - 1X</span>
                           </div>
                        ...
                        <section>
                           <div className="flex flex-col items-center mt-10 mb-2 font-semibold">
                              <span className="border border-slate-400 px-3 py-1 rounded-md">Surat Al Baqarah (284-286) - 1X</span>
                           </div>
                        ...
                        <section>
                           <div className="flex flex-col items-center mt-10 mb-2 font-semibold">
                              <span className="border border-slate-400 px-3 py-1 rounded-md">Surat Al Ikhlas (1-4) - 3X</span>
                              <span className="arab" style={{ fontSize: option.ar + "px" }}>
                                 بِسْمِ اللّٰهِ الرَّحْمٰنِ الرَّحِيْمِ
                              </span>
                           </div>
                           ...
                           <div className="border border-slate-300 rounded-lg overflow-hidden">
                              {data.alikhlas.map((surat) => (
                                 ...
                                 >
                                    <div className="text-xl md:ml-5 flex justify-between md:block gap-1 px-3 top-2 w-full mb-3 md:w-fit md:mb-0 md:px-0 absolute left-0 border-b border-dashed border-slate-200 pb-2 md:border-0">
                                       <div className="flex md:block w-full gap-2">
                                          <div className="w-auto border md:border-slate-200 rounded-md text-sm px-1 lg:mt-3 nunito font-semibold">Al Ikhlas : {surat.nomor}</div>
                                       </div>
                                    </div>
                        ...
                        <section>
                           <div className="flex flex-col items-center mt-10 mb-2 font-semibold">
                              <span className="border border-slate-400 px-3 py-1 rounded-md">Surat Al Falaq (1-5) - 3X</span>
                              <span className="arab" style={{ fontSize: option.ar + "px" }}>
                                 بِسْمِ اللّٰهِ الرَّحْمٰنِ الرَّحِيْمِ
                              </span>
                           </div>
                           ...
                           <div className="border border-slate-300 rounded-lg overflow-hidden">
                              {data.alfalaq.map((surat) => (
                                 ...
                                 >
                                    <div className="text-xl md:ml-5 flex justify-between md:block gap-1 px-3 top-2 w-full mb-3 md:w-fit md:mb-0 md:px-0 absolute left-0 border-b border-dashed border-slate-200 pb-2 md:border-0">
                                       <div className="flex md:block w-full gap-2">
                                          <div className="w-auto border md:border-slate-200 rounded-md text-sm px-1 lg:mt-3 nunito font-semibold">Al Falaq : {surat.nomor}</div>
                                       </div>
                                    </div>
                        ...
                        <section>
                           <div className="flex flex-col items-center mt-10 mb-2 font-semibold">
                              <span className="border border-slate-400 px-3 py-1 rounded-md">Surat An Nas (1-6) - 3X</span>
                              <span className="arab" style={{ fontSize: option.ar + "px" }}>
                                 بِسْمِ اللّٰهِ الرَّحْمٰنِ الرَّحِيْمِ
                              </span>
                           </div>
                           ...
                           <div className="border border-slate-300 rounded-lg overflow-hidden">
                              {data.annas.map((surat) => (
                                 ...
                                 >
                                    <div className="text-xl md:ml-5 flex justify-between md:block gap-1 px-3 top-2 w-full mb-3 md:w-fit md:mb-0 md:px-0 absolute left-0 border-b border-dashed border-slate-200 pb-2 md:border-0">
                                       <div className="flex md:block w-full gap-2">
                                          <div className="w-auto border md:border-slate-200 rounded-md text-sm px-1 lg:mt-3 nunito font-semibold">An Nas : {surat.nomor}</div>
                                       </div>
                                    </div>
                        ...
                        {data.almatsurat.map((surat) => (
                           <section key={Math.random(20)}>
                              <div className="flex flex-col items-center mt-10 mb-2 font-semibold">
                                 <span className="border border-slate-400 px-3 py-1 rounded-md">{surat.heading}</span>
                              </div>
                              ...
                              <div className="border border-slate-300 rounded-lg overflow-hidden">
                                 <div className="px-5 flex flex-wrap justify-end md:h-full md:items-center not-last:border-b border-slate-300 dark:border-slate-400/80 pt-14 pb-5 md:py-9 relative">
                                    <div className="text-xl md:ml-5 flex justify-between md:block gap-1 px-3 top-2 w-full mb-3 md:w-fit md:mb-0 md:px-0 absolute left-0 border-b border-dashed border-slate-200 pb-2 md:border-0">
                                       <div className="flex md:block w-full gap-2">
                                          <div className="w-auto border md:border-slate-200 rounded-md text-sm px-1 lg:mt-3 nunito font-semibold">Al-Matsurat</div>
                                       </div>
                                    </div>
                        ...
                        <section>
                           <div className="flex flex-col items-center mt-10 mb-2 font-semibold">
                              <span className="border border-slate-400 px-3 py-1 rounded-md">Surat Ali Imron (26-27) - 1X</span>
                           </div>
                           ...
                           <div className="border border-slate-300 rounded-lg overflow-hidden">
                              {data.aliimron.map((surat) => (
                                 ...
                                 >
                                    <div className="text-xl md:ml-5 flex justify-between md:block gap-1 px-3 top-2 w-full mb-3 md:w-fit md:mb-0 md:px-0 absolute left-0 border-b border-dashed border-slate-200 pb-2 md:border-0">
                                       <div className="flex md:block w-full gap-2">
                                          <div className="w-auto border md:border-slate-200 rounded-md text-sm px-1 lg:mt-3 nunito font-semibold">Ali Imron : {surat.nomor}</div>
                                       </div>
                                    </div>
                        ...
                        <section>
                           <div className="flex flex-col items-center mt-10 mb-2 font-semibold">
                              <span className="border border-slate-400 px-3 py-1 rounded-md">Do'a Robithoh - 3X</span>
                           </div>
                           ...
                           <div className="border border-slate-300 rounded-lg overflow-hidden">
                              {data.robithoh.map((surat) => (
                                 ...
                                 >
                                    <div className="text-xl md:ml-5 flex justify-between md:block gap-1 px-3 top-2 w-full mb-3 md:w-fit md:mb-0 md:px-0 absolute left-0 border-b border-dashed border-slate-200 pb-2 md:border-0">
                                       <div className="flex md:block w-full gap-2">
                                          <div className="w-auto border md:border-slate-200 rounded-md text-sm px-1 lg:mt-3 nunito font-semibold">Do'a Robithoh</div>
                                       </div>
                                    </div>
