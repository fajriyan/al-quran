   ...
   return (
      <>
         ...
         <div className="container mx-auto h-screen flex items-center px-3 md:px-0">
            <div className="">
               <h1 className="text-xl md:text-3xl font-bold">Halaman yang Anda Akses Tidak ditemukan.</h1>
               <p className="text-sm md:text-md pb-5 pt-1 w-[80%]">Error 404, Silahkan Kembali ke Beranda atau Hubungi Admin</p>
               <Link
