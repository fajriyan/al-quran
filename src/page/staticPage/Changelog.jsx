      ...
      <>
         ...
         <div className="container mx-auto py-5 px-3 md:px-0 min-h-screen">
            <div className="flex items-center gap-3">
               <Link to={"/"}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-arrow-left-short hover:scale-110" viewBox="0 0 16 16">
                     <path
                        fillRule="evenodd"
            ...
            <div className="mt-3">
                        ...
                        {loading
                           ...
                           : commits.map((commit) => (
                                <tr key={commit.sha} className="text-sm">
                                   <td className="border px-2 py-1 text-center">{commit.sha.substring(0, 7)}</td>
                                   <td className="border px-2 py-1 text-center">{new Date(commit.commit.author.date).toLocaleDateString()}</td>
                                   <td className="border px-2 py-1">{commit.commit.message}</td>
                                   <td className="border px-2 py-1 text-center">
                                      <button
                                         onClick={() => window.open(`https://github.com/fajriyan/al-quran/commit/${commit.sha}`, "_blank")}
               ...
               <div className="mt-3 mb-6">
                  <a href="https://github.com/fajriyan/al-quran/issues/new" className="px-5 py-2 rounded-md bg-slate-800 hover:bg-slate-900 font-medium text-white ">
                     Report Bug
                  </a>
               </div>
            </div>
